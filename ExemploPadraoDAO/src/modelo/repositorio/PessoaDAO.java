...
//	SELECT * FROM PESSOAS WHERE ID = ?
	...
	public Pessoa recuperarPessoaPorId(int id) {
		...
		try {
			...
			System.out.println("Erro ao tentar recuperar pessoa com ID " + id + ". " + e.getMessage());
		}
...
//	DELETE FROM PESSOAS
	...
	public int removerPessoa(int id)
	{
		...
		try {
			...
			System.out.println("Erro ao excluir o registro da pessoa! " + e.getMessage());
		}
